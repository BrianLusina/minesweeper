module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@storage/(.*)$': '<rootDir>/src/libs/storage/$1',
    '^@cookie': '<rootDir>/src/libs/storage/cookie/cookie.ts',
    '^@cache': '<rootDir>/src/libs/storage/cache/cache.ts',
    '^@localStorage': '<rootDir>/src/libs/storage/local/local.ts',
    '^@sessionStorage': '<rootDir>/src/libs/storage/session/session.ts',
    '^@logger': '<rootDir>/src/libs/logger/index.ts',
    '^@analytics': '<rootDir>/src/libs/analytics/index.ts',
    '^@monitoring': '<rootDir>/src/libs/monitoring/index.ts',
